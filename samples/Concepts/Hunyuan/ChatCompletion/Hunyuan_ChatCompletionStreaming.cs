namespace Hunyuan.ChatCompletion;

// The following example shows how to use Semantic Kernel with streaming Chat Completion
public class Hunyuan_ChatCompletionStreaming(ITestOutputHelper output) : BaseTest(output)
{
    [Fact]
    public Task RunAsync()
    {
        Console.WriteLine("======== Hunyuan - Chat Streaming ========");

        HunyuanChatCompletionService chatCompletionService = new("hunyuan-lite", TestConfiguration.Hunyuan.SecretId, TestConfiguration.Hunyuan.SecretKey);
